          ...
          <div className="flex flex-col md:flex-row gap-10 md:gap-20">
            <div className="flex flex-col items-start justify-center">
              <div className="relative cursor-default">
                <span className="material-symbols-outlined text-8xl md:text-9xl text-zinc-800 transition-transform duration-500 maker-icon maker-icon-main">
                  science
                </span>
                <span className="absolute -top-3 -right-3 flex h-8 w-8 items-center justify-center rounded-full bg-[#c95a5a] text-white text-xs font-bold shadow-lg maker-badge">
            ...
            <div className="flex-1 space-y-6">
              <div>
                <h2 className="font-space text-5xl md:text-7xl font-black uppercase tracking-tight text-zinc-900 leading-[1.1] text-balance title-maker cursor-default">
                  Espaço Maker
                </h2>
                <p className="font-space text-2xl md:text-4xl font-light text-zinc-500 mt-2 tracking-wide title-lab cursor-default">
                  Laboratórios
                </p>
        ...
        <div className="max-w-4xl mx-auto relative z-10 overflow-hidden rounded-[32px] shadow-2xl border-l-8 border-black bg-gradient-to-br from-[#c95a5a] via-[#b94d4d] to-[#8b1e35] p-10 text-white form-card-hover">
          ...
          <div className="relative">
            ...
            <form className="space-y-10" onSubmit={handleSubmit}>
              <fieldset>
                <legend className="text-xl mb-5 label-hover inline-block">
                  5. Maquinário a ser utilizado para a reserva: <span className="required-asterisk">*</span>
                </legend>
                <div className="grid md:grid-cols-3 gap-4">
                  <label className="cursor-pointer">
                    <input type="radio" name="maquinario" className="peer hidden" required />
                    <div className="p-5 rounded-2xl bg-white/10 border border-white/30 transition-all radio-card peer-checked:bg-white peer-checked:text-[#1e1e1e] peer-checked:shadow-[0_0_25px_rgba(255,180,120,0.7)]">
                      <span className="material-symbols-outlined text-2xl mb-2 block">laser</span>
                      <span className="font-medium">Cortadora a laser</span>
                    </div>
                  </label>
                  <label className="cursor-pointer">
                    <input type="radio" name="maquinario" className="peer hidden" />
                    <div className="p-5 rounded-2xl bg-white/10 border border-white/30 transition-all radio-card peer-checked:bg-white peer-checked:text-[#1e1e1e] peer-checked:shadow-[0_0_25px_rgba(255,180,120,0.7)]">
                      <span className="material-symbols-outlined text-2xl mb-2 block">view_in_ar</span>
                      <span className="font-medium">Impressora 3D</span>
                    </div>
                  </label>
                  <label className="cursor-pointer">
                    <input type="radio" name="maquinario" className="peer hidden" />
                    <div className="p-5 rounded-2xl bg-white/10 border border-white/30 transition-all radio-card peer-checked:bg-white peer-checked:text-[#1e1e1e] peer-checked:shadow-[0_0_25px_rgba(255,180,120,0.7)]">
                      <span className="material-symbols-outlined text-2xl mb-2 block">router</span>
                      <span className="font-medium">Router CNC</span>
                    </div>
                  </label>
                </div>
              </fieldset>
              <div>
                <label className="block mb-2 text-lg label-hover">
                  6. Professor solicitante: <span className="required-asterisk">*</span>
                </label>
                <input
                  type="text"
              ...
              <div>
                <label className="block mb-2 text-lg label-hover">
                  7. A que se destina o projeto: <span className="required-asterisk">*</span>
                </label>
                <input
                  type="text"
              ...
              <div>
                <label className="block mb-2 text-lg label-hover">
                  8. Qual a sua turma: <span className="required-asterisk">*</span>
                </label>
                <input
                  type="text"
              ...
              <div>
                <label className="block mb-2 text-lg label-hover">
                  9. Data de utilização do maquinário: <span className="required-asterisk">*</span>
                </label>
                <input
                  type="date"
                  required
              ...
              <div>
                <label className="block mb-2 text-lg label-hover">
                  10. Horário de início da atividade: <span className="required-asterisk">*</span>
                </label>
                <input
                  type="time"
                  required
              ...
              <div>
                <label className="block mb-2 text-lg label-hover">
                  11. Horário de finalização da atividade: <span className="required-asterisk">*</span>
                </label>
                <input
                  type="time"
                  required
